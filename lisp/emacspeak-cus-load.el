...
(put 'emacspeak 'custom-loads '(emacspeak-add-log emacspeak-keymap emacspeak-atom emacspeak-aumix emacspeak-daisy emacspeak-dismal emacspeak-ediff emacspeak-wizards emacspeak-erc emacspeak-eshell emacspeak-eterm emacspeak-eudc emacspeak-flyspell emacspeak-forms emacspeak-gnus emacspeak-ido emacspeak-ispell emacspeak-m-player emacspeak emacspeak-message emacspeak-midge emacspeak-nxml emacspeak-ocr emacspeak-pronounce emacspeak-realaudio emacspeak-replace emacspeak-rss emacspeak-sounds emacspeak-speak emacspeak-speedbar emacspeak-table-ui emacspeak-view-process emacspeak-vm emacspeak-w3 emacspeak-w3m emacspeak-websearch emacspeak-widget emacspeak-xml-shell emacspeak-xslt dtk-speak voice-setup))
...
(put 'atom-blogger 'custom-loads '("old-atom-blogger"))
...
(put 'applications 'custom-loads '("old-atom-blogger" emacspeak g))
...
(put 'emacspeak-atom 'custom-loads '(emacspeak-atom))
...
(put 'g 'custom-loads '(g-utils g-auth gblogger gcal gnotebook greader gsheet))
