...
;;; $Id: emacspeak-wizards.el,v 22.0 2005/04/30 16:40:02 raman Exp $
;;; $Author: raman $
...
Warning! Contents of file commands.texi will be overwritten."
  ...
  (let ((emacspeak-speak-messages nil)
    ...
    (save-excursion
      (set-buffer buffer)
      (erase-buffer)
      (insert"@c $Id: emacspeak-wizards.el,v 22.0 2005/04/30 16:40:02 raman Exp $\n")
      (insert
